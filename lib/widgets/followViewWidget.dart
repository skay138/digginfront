...
class FollowViewWidget extends StatefulWidget {
  final String uid;
  final bool follower;

  const FollowViewWidget(
      {super.key, required this.uid, required this.follower});

  @override
  State<FollowViewWidget> createState() => _FollowViewWidgetState();
}

class _FollowViewWidgetState extends State<FollowViewWidget> {
